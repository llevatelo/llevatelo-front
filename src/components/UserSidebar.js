...
import ImageAuthor01 from '../components/assets/img/author-01.jpg';
            ...
            <div className="col-md-4">
                ...
                <section>
                    ...
                    <form className="form email">
                        ...
                        <textarea name="message" id="message" className="form-control" rows={4} placeholder="Hi there! I am interested in your offer ID 53951. Please give me more details." defaultValue={""} />
                        </div>
                        {/*end form-group*/}
