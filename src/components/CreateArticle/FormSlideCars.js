            ...
            <div className="form-slide" id="cars_motorcycles">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="cars_motorcycles___type" className="col-form-label">Vehicle Type</label>
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            <label htmlFor="cars_motorcycles___status" className="col-form-label">Status</label>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="form-group">
                            <label htmlFor="cars_motorcycles___brand" className="col-form-label">Vehicle Type</label>
                    ...
                    <div className="col-md-4">
                        <div className="form-group">
                            <label htmlFor="cars_motorcycles___model" className="col-form-label">Model</label>
                    ...
                    <div className="col-md-4">
                        <div className="form-group">
                            <label htmlFor="cars_motorcycles___year" className="col-form-label">Year</label>
                            <input name="cars_motorcycles___year" type="text" className="form-control" id="cars_motorcycles___year" />
                        </div>
                    {/*end form-group*/}
                    </div>
                    {/*end col-md-4*/}
