    ...
    return (
      <div className="form-slide" id="computers">
        ...
        <div className="row">
          <div className="col-md-4">
            <div className="form-group">
              <label htmlFor="computers___processor" className="col-form-label">
                Processor
              </label>
              <select
                name="computers___processor"
                id="computers___processor"
          ...
          <div className="col-md-4">
            <div className="form-group">
              <label htmlFor="computers___frequency" className="col-form-label">
                Frequency
              </label>
              <input
                name="computers___frequency"
                type="text"
          ...
          <div className="col-md-4">
            <div className="form-group">
              <label htmlFor="computers___cores" className="col-form-label">
                Cores
              </label>
              <input
                name="computers___cores"
                type="text"
                className="form-control"
        ...
        <div className="row">
          <div className="col-md-4">
            <div className="form-group">
              <label htmlFor="computers___ram" className="col-form-label">
                RAM
              </label>
              <input
                name="computers___ram"
                type="text"
                className="form-control"
                id="computers___ram"
              />
          ...
          <div className="col-md-4">
            <div className="form-group">
              <label
                htmlFor="computers___main_board"
                className="col-form-label"
              >
                Main Board
              </label>
              <input
                name="computers___main_board"
                type="text"
                className="form-control"
          ...
          <div className="col-md-4">
            <div className="form-group">
              <label htmlFor="computers___os" className="col-form-label">
                OS
              </label>
              <select
                name="computers___os"
        ...
        {/*end row*/}
        <div className="form-group">
          <label htmlFor="computers___other_details" className="col-form-label">
            Other Details
          </label>
          <textarea
            name="computers___other_details"
            id="computers___other_details"
            className="form-control"
            rows={4}
            defaultValue={""}
          />
