            ...
            <div className="container">
              <section>
                <div className="alert alert-warning" role="alert">
                  ...
                  <p>
                    You can submit only 1 ad at a time. To submit more, you need
                    to
                    <a href="sign-in.html" className="link">
              ...
              <form className="form form-submit">
                ...
                <section>
                  ...
                  <div className="file-upload">
                    <input
                      type="file"
                      name="files[]"
                      className="file-upload-input with-preview"
                      multiple
                ...
                <section className="clearfix">
                  <div className="form-group">
                    <button
                      type="submit"
                      className="btn btn-primary large icon float-right"
                    >
                      Preview
