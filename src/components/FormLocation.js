    ...
    render() {
        return (
            <section>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="form-group">
                            <label htmlFor="city" className="col-form-label required">City</label>
                    ...
                    <div className="col-md-4">
                        <div className="form-group">
                            <label htmlFor="district" className="col-form-label required">District</label>
                ...
                {/*end row*/}
                <div className="form-group">
                    <label htmlFor="input-location" className="col-form-label">Exact Location</label>
                ...
                <input name="latitude" type="text" className="form-control" id="latitude" hidden />
                <input name="longitude" type="text" className="form-control" id="longitude" hidden />
            </section>
        );
    }
}
