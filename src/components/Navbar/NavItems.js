        ...
        return (
            <div className="col-md-3">
                <nav className="nav flex-column side-nav">
                    ...
                    <a className={"nav-link icon " + (this.props.path === 'Bookmarks' ? ' active' : '')} href="/bookmarks">
                        <i className="fa fa-star" />Bookmarks
                    </a>
                    <a className={"nav-link icon " + (this.props.path === 'ChangePassword' ? ' active' : '')} href="/change-password">
                    <i className="fa fa-recycle" />Change Password
                    </a>
                    <a className={"nav-link icon " + (this.props.path === 'SoldItems' ? ' active' : '')} href="/sold-items">
